...
| Service Page body, body_bn, hop page copy, longer description Markdown | ADR-0008, `src/lib/markdown.ts`, `src/pages/services/[slug].astro`, `CONTEXT.md` (Service Page v1), Trap #9 |
