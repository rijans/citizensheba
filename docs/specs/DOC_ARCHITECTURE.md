...
| **2 — Guides** | `docs/guides/*.md` | Agent workflow, frontend, performance (deep reference). |
...
1. Pick owner: glossary → `CONTEXT.md`; irreversible decision → new/updated ADR; ops → `docs/ops/`; agent routing → row in `INDEX.md`; recurring pitfall → `TRAPS.md`; how-to → `docs/guides/`.
