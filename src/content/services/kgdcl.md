...
body: |
  **KGDCL** (Karnaphuli Gas Distribution Company Limited) is the official gas distribution portal for company notices and published customer information in its franchise areas.
  ...
  Other distribution companies such as Titas Gas and SGCL remain separate Services.

body_bn: |
  **কেজিডিসিএল** (কর্ণফুলী গ্যাস ডিস্ট্রিবিউশন কোম্পানি লিমিটেড) কোম্পানি নোটিশ ও প্রকাশিত গ্রাহক তথ্যের অফিসিয়াল গ্যাস বিতরণ পোর্টাল।

  তিতাস গ্যাস ও এসজিসিএলের মতো অন্য বিতরণ কোম্পানি আলাদা সেবা।

url: "https://kgdcl.gov.bd/"
official_domain: kgdcl.gov.bd
category: utilities
...
capabilities:
  ...
  - en: "Read KGDCL notices"
    bn: "কেজিডিসিএল নোটিশ"
  - en: "View distribution updates"
    bn: "বিতরণ আপডেট দেখুন"
tags: [kgdcl, gas, karnaphuli, "কেজিডিসিএল", "কর্ণফুলী"]
aliases:
  ...
  - name: Karnaphuli Gas
    lang: en
    kind: informal
  - name: কর্ণফুলী গ্যাস ডিস্ট্রিবিউশন কোম্পানি
    lang: bn
    kind: alt
  - name: কর্ণফুলী গ্যাস
    lang: bn
